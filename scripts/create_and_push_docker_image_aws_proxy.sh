...
docker build --build-arg MLFLOW_TRACKING_URI=$MLFLOW_TRACKING_URI -f ./DockerfileAWSProxy -t quay.io/wadkars/mock-jit:awsv5 .
docker push quay.io/wadkars/mock-jit:awsv5
