...
docker build --build-arg MLFLOW_TRACKING_URI=$MLFLOW_TRACKING_URI -f ./DockerfileProxy -t quay.io/wadkars/mock-jit:v14 .
docker push quay.io/wadkars/mock-jit:v14
